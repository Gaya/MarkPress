<?php
include "MarkPressNote.php";
include "MarkPressPostType.php";
include "MarkPressAjaxCatcher.php";
...
class MarkPress {
	...
	function __construct($plugin_dir) {
		...
		$this->postType = new MarkPressPostType();
		$this->ajax = new MarkPressAjaxCatcher();
